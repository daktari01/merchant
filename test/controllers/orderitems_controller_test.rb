...
class OrderitemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create orderitem" do
    assert_difference('Orderitem.count') do
      post orderitems_url, params: { orderitem: { order_id: @orderitem.order_id, product_id: @orderitem.product_id, quantity: @orderitem.quantity } }
    end
  ...
  test "should update orderitem" do
    patch orderitem_url(@orderitem), params: { orderitem: { order_id: @orderitem.order_id, product_id: @orderitem.product_id, quantity: @orderitem.quantity } }
