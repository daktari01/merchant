class OrderItemsController < ApplicationController
  ...
  def update
    respond_to do |format|
      ...
      if params[:order_item][:quantity].to_i == 0
        @order_item.destroy
        format.html { redirect_to orders_path, notice: 'Order item was successfully deleted.' }
  ...
  def destroy
    @order_item.destroy
    respond_to do |format|
      format.html { redirect_to orders_url(session[:order_id]), notice: 'Order item was successfully destroyed.' }
